...
/**
 * @minions-content-assets/cli — CLI for Minions Content-assets
 *
...
import { customTypes } from '@minions-content-assets/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Content-assets'));
        console.log(chalk.dim('Text posts, image briefs, video briefs, and generated asset references'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-content-assets/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-content-assets/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-content-assets')}`);
